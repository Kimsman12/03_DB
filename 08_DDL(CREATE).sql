...
-- ** JDBC 에서 날짜를 입력 받았을때 삽입하는 방법**
-- '2024-10-15 12:20:30' 이런식의 문자열이 넘어온 경우

INSERT INTO "MEMBER" VALUES
('MEM04','PASS04','김길동','931201-1234567',TO_DATE('2024-10-15 12:20:30', 'YYYY-MM-DD HH24:MI:SS'));
...
-- ORA-01400: NULL을 ("KH_KKM"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_KKM.USER_ID_NAME_U)에 위배됩니다
...
-- * 복합키는 지정된 모든 컬럼의 값이 같을 떄 위배된다



------------------------------------------------------------------------------------------------------

-- 3. PRIMARY KYE (기본키) 제약조건

-- 테이블에서 한 행의 정보를 찾기위해 사용할 컬럼을 의미함
-- 테이블에 대한 식별자(사용자번호, 학번 등) 역할을 함

-- NOT NULL + UNIQUE 제약조건의 의미 -> 중복되지 않는 값이 필수로 존재해야함

-- 한테이블당 한개만 설정할 수 있음
-- 컬럼레벨, 테이블레벨 둘 다 설정가능
-- 한 개 컬럼에 설정할 수 있고, 여러개의 컬럼을 묶어서 설정할 수 있음 (== PRIMARY복합키)

CREATE TABLE USER_USED_PK(
	USER_NO NUMBER CONSTRAINT USER_NO_PK PRIMARY KEY, -- 컬럼레벨(제약조건 지정) 
	USER_ID VARCHAR2(20),
	USER_PWD VARCHAR2(20),
	USER_NAME VARCHAR2(30),
	GENDER VARCHAR2(10),
...
-- SQL Error [1] [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_KKM.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES (2, 'USER03', 'PASS03', '유관순', '여자', '010-3333-3333', '	you123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: 
-- NULL을 ("KH_KKM"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_PK2
VALUES (2, 'USER02', 'PASS02', '이순신', '남자', '010-2222-2222', 'lee123@kh.or.kr');

INSERT INTO USER_USED_PK2
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 
-- 무결성 제약 조건(KH_KKM.PK_USERNO_USERID)에 위배됩니다

INSERT INTO USER_USED_PK2
VALUES (NULL, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KKM"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2
VALUES (3, NULL, 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KKM"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_USED_FK(
	USER_NO NUMBER PRIMARY KEY, -- 사용자 번호(고유번호 : 중복, NULL X)
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE --> 컬럼 레벨
...
-- USER_GRADE (부모/참조 테이블)에 10이라는 GRADE_CODE 가 존재하므로 가능함

INSERT INTO USER_USED_FK
VALUES (2, 'USER02', 'PASS02', '이순신', '남자', '010-2222-2222', 'lee123@kh.or.kr', 10);

INSERT INTO USER_USED_FK
VALUES (3, 'USER03', 'PASS03', '유관순', '여자', '010-3333-3333', 'you123@kh.or.kr', 30);

INSERT INTO USER_USED_FK
VALUES (4, 'USER04', 'PASS04', '안중근', '남자', '010-4444-4444', 'an123@kh.or.kr', NULL);

INSERT INTO USER_USED_FK
VALUES (5, 'USER05', 'PASS05', '윤봉길', '남자', '010-5555-5555', 'yoon123@kh.or.kr', 50);
-- SQL Error [2291] [23000]: ORA-02291: 무결성 제약조건(KH_KKM.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- 1) ON DELETE RESTRICTED(삭제 제한) 으로 기본 지정되어있음
-- FOREIGN KEY로 지정된 컬럼에서 사용되고 있는 값일 경우
-- 제공하는 컬럼의 값은 삭제하지 못함

DELETE FROM USER_GRADE WHERE GRADE_CODE = 30;
-- SQL Error [2292] [23000]: 
-- ORA-02292: 무결성 제약조건(KH_KKM.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
-- 3) ON DELETE CASEADE : 부모키 삭제시 자식키도 함께 삭제됨
-- 부모키 삭제시 값을 사용하고 있던 자식 테이블의 컬럼에 해당하는 행이 삭제됨
...
-- ON DELETE CASEADE 삭제 옵션이 적용된 자식 테이블 생성
CREATE TABLE USER_USED_FK3(
	...
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER, 
	CONSTRAINT GRADE_CODE_FK3 REFERENCES USER_GRADE3(GRADE_CODE) ON DELETE CASCADE
);
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_KKM.GENDER_CHECK)이 위배되었습니다
...
INSERT INTO USER_USED_CHECK
VALUES (2, 'USER02', 'PASS02', '유관순', '여', '010-2222-2222', 'you123@kh.or.kr');
-- 가능

INSERT INTO USER_USED_CHECK
VALUES (3, 'USER03', 'PASS03', '신사임당', '여자', '010-3333-3333', 'sin123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_KKM.GENDER_CHECK)이 위배되었습니다

--> GENDER 컬럼에 CHECK 제약조건으로 '남' 또는'여' 만 삽입가능하도록 설정해둠
