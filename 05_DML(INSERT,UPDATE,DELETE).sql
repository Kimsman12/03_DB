...
-- 윈도우 > 설정 > 연결 > 연결유형 Auto commit default 체크 해제되어 있는지 확인
...
VALUES('900', '홍길동', '991225-1234567', 'hong_gd@or.kr', '01011111111', 
...
-- 선택 안된 컬럼은 값이 NULL (DEFAULT 존재 시 DEFAULT 설정한 값으로 삽입됨)
INSERT INTO EMPLOYEE2 (EMP_ID, EMP_NAME, EMP_NO, EMAIL, PHONE, DEPT_CODE, JOB_CODE, SAL_LEVEL, SALARY)
VALUES('900', '홍길동', '991225-1234567', 'hong_gd@or.kr', '01011111111', 'D1', 'J7', 'S3', 4300000);
...
SELECT * FROM EMPLOYEE2
WHERE EMP_ID = '900'; -- 조회 다시 해봄(영구저장 되었기 때문에 롤백 불가)
...
SELECT * FROM EMP_M02; -- 5명 (기존4명 + 신규1)
